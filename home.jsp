...
<h2>About Us</h2></header>
				<div class="reel">
					...
					<article>
						...
						<p><b>Lead Developer</b><br />Bachelor's in Computer Engineering <br />Master's in Software Engineering</p>							
					</article>
					...
					<article>
						...
						<p><b>Development and Design</b><br />Bachelor's in Computer Engineering <br />Master's in Software Engineering</p>							
					</article>
					...
					<article>
						...
						<p><b>Database and Development</b><br />Bachelor's in Computer Engineering <br />Master's in Software Engineering</p>							
					</article>
					...
					<article>
						...
						<p><b>Lead Designer</b><br />Bachelor's in Computer Science <br />Master's in Computer Science</p>							
					</article>
					...
					<article>
						...
						<p><b>Operations and Logo Creation</b><br />Bachelor's in Electrical Engineering <br />Master's in Software Engineering</p>							
					</article>
					...
					<article>
						...
						<p><b>Design Team</b><br />Bachelor's in Information Technology <br />Master's in Software Engineering</p>							
					</article>
					...
					<article>
						...
						<p><b>Content Creation</b><br />Bachelor's in Computer Engineering <br />Master's in Software Engineering</p>							
					</article>
			...
			<div class="wrapper style1">
				...
				<section id="contact" class="container special">
					...
					<div class="row 200%">
                        ...
                        <li><p><strong>E-mail:</strong><br>holmeslaundry@gmail.com</p></li>
						<li><p><strong>Map<a href="map.jsp" target="new"></strong><br><img src="images/image.png"/></a></p></li>
